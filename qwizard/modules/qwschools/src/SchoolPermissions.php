...
use Drupal\qwschools\Entity\School;
use Drupal\qwschools\Entity\SchoolType;

/**
 * Provides dynamic permissions for School of different types.
 *
 * @ingroup qwschools
 *
 */
class SchoolPermissions{
   ...
   *
   * @return array
   *   The School by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (SchoolType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\qwschools\Entity\School $type
   *   The School type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(SchoolType $type) {
    $type_id = $type->id();
